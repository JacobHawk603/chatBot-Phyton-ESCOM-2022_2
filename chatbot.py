...
def check_all_messages(message):
    ...
    response(respuestas['articulo31'][0]['respuesta'], ['articulo', 'treinta y uno'], required_words=['articulo', 'treintayuno'])
    response(respuestas['articulo32'][0]['respuesta'], ['articulo', 'treinta y dos'], required_words=['articulo', 'treintaydos'])
    response(respuestas['articulo33'][0]['respuesta'], ['articulo', 'treinta y tres'], required_words=['articulo', 'treintaytres'])
    response(respuestas['articulo34'][0]['respuesta'], ['articulo', 'treinta y cuatro'], required_words=['articulo', 'treintaycuatro'])
    response(respuestas['articulo35'][0]['respuesta'], ['articulo', 'treinta y cinco'], required_words=['articulo', 'treintaycinco'])
    response(respuestas['articulo36'][0]['respuesta'], ['articulo', 'treinta y seis'], required_words=['articulo', 'treintayseis'])
    response(respuestas['articulo37'][0]['respuesta'], ['articulo', 'treinta y siete'], required_words=['articulo', 'treintaysiete'])
    response(respuestas['articulo38'][0]['respuesta'], ['articulo', 'treinta y ocho'], required_words=['articulo', 'treintayocho'])
    response(respuestas['articulo39'][0]['respuesta'], ['articulo', 'treinta y nueve'], required_words=['articulo', 'treintaynueve'])
    response(respuestas['articulo40'][0]['respuesta'], ['articulo', 'cuarenta'], required_words=['articulo', 'cuarenta'])
    response(respuestas['articulo41'][0]['respuesta'], ['articulo', 'cuarenta y uno'], required_words=['articulo', 'cuarentayuno'])
    response(respuestas['articulo42'][0]['respuesta'], ['articulo', 'cuarenta y dos'], required_words=['articulo', 'cuarentaydos'])
    response(respuestas['articulo43'][0]['respuesta'], ['articulo', 'cuarenta y tres'], required_words=['articulo', 'cuarentaytres'])
    response(respuestas['articulo44'][0]['respuesta'], ['articulo', 'cuarenta y cuatro'], required_words=['articulo', 'cuarentaycuatro'])
    response(respuestas['articulo45'][0]['respuesta'], ['articulo', 'cuarenta y cinco'], required_words=['articulo', 'cuarentaycinco'])
    response(respuestas['articulo46'][0]['respuesta'], ['articulo', 'cuarenta y seis'], required_words=['articulo', 'cuarentayseis'])
    response(respuestas['articulo47'][0]['respuesta'], ['articulo', 'cuarenta y siete'], required_words=['articulo', 'cuarentaysiete'])
    response(respuestas['articulo48'][0]['respuesta'], ['articulo', 'cuarenta y ocho'], required_words=['articulo', 'cuarentayocho'])
    response(respuestas['articulo49'][0]['respuesta'], ['articulo', 'cuarenta y nueve'], required_words=['articulo', 'cuarentaynueve'])
    response(respuestas['articulo50'][0]['respuesta'], ['articulo', 'cincuenta'], required_words=['articulo', 'cincuenta'])
    response(respuestas['articulo51'][0]['respuesta'], ['articulo', 'cincuenta y uno'], required_words=['articulo', 'cincuentayuno'])
    response(respuestas['articulo52'][0]['respuesta'], ['articulo', 'cincuenta y dos'], required_words=['articulo', 'cincuentaydos'])
    response(respuestas['articulo53'][0]['respuesta'], ['articulo', 'cincuenta y tres'], required_words=['articulo', 'cincuentaytres'])
    response(respuestas['articulo54'][0]['respuesta'], ['articulo', 'cincuenta  y cuatro'], required_words=['articulo', 'cincuentaycuatro'])
    response(respuestas['articulo55'][0]['respuesta'], ['articulo', 'cincuenta y cinco'], required_words=['articulo', 'cincuentaycinco'])
    response(respuestas['articulo56'][0]['respuesta'], ['articulo', 'cincuenta y seis'], required_words=['articulo', 'cincuentayseis'])
    response(respuestas['articulo57'][0]['respuesta'], ['articulo', 'cincuenta y siete'], required_words=['articulo', 'cincuentaysiete'])
    response(respuestas['articulo58'][0]['respuesta'], ['articulo', 'cincuenta y ocho'], required_words=['articulo', 'cincuentayocho'])
    response(respuestas['articulo59'][0]['respuesta'], ['articulo', 'cincuenta y nueve'], required_words=['articulo', 'cincuentaynueve'])
    response(respuestas['articulo60'][0]['respuesta'], ['articulo', 'sesenta'], required_words=['articulo', 'sesenta'])
    response(respuestas['articulo61'][0]['respuesta'], ['articulo', 'sesenta y uno'], required_words=['articulo', 'sesentayuno'])
    response(respuestas['articulo62'][0]['respuesta'], ['articulo', 'sesenta y dos'], required_words=['articulo', 'sesentaydos'])
    response(respuestas['articulo63'][0]['respuesta'], ['articulo', 'sesenta y tres'], required_words=['articulo', 'sesentaytres'])
    response(respuestas['articulo64'][0]['respuesta'], ['articulo', 'sesenta y cuatro'], required_words=['articulo', 'sesentaycuatro'])
    response(respuestas['articulo65'][0]['respuesta'], ['articulo', 'sesenta y cinco'], required_words=['articulo', 'sesentaycinco'])
    response(respuestas['articulo66'][0]['respuesta'], ['articulo', 'sesenta y seis'], required_words=['articulo', 'sesentayseis'])
    response(respuestas['articulo67'][0]['respuesta'], ['articulo', 'sesenta y siete'], required_words=['articulo', 'sesentaysiete'])
    response(respuestas['articulo68'][0]['respuesta'], ['articulo', 'sesenta y ocho'], required_words=['articulo', 'sesentayocho'])
    response(respuestas['articulo69'][0]['respuesta'], ['articulo', 'sesenta y nueve'], required_words=['articulo', 'sesentaynueve'])
